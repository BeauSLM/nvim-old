...
function Lazyload()
  ...
  if gitrepo then
    loader("gitsigns.nvim vim-fugitive gv.vim")  -- vgit.nvim
  end
  ...
  if load_ts_plugins then
    plugins =
      "nvim-treesitter-refactor nvim-ts-autotag nvim-ts-context-commentstring nvim-treesitter-textsubjects" --  nvim-ts-rainbow  nvim-treesitter nvim-treesitter-refactor
...
vim.defer_fn(function()
  local loader = require("packer").loader
  loader("telescope.nvim telescope-zoxide project.nvim")
